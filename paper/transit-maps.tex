...
After the node fronts have been expanded, the line connections in the node can be rendered independently from the edges by connecting the port pairs. In our experiments, we used cubic Bezi\'{e}r curves, but for schematic maps a circular arc or even a straight line might be preferable.
