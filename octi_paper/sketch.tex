...
\begin{figure}
  \centering
	...
	\caption{Left: Part of an input graph $G$ with edges $e, f$ and $g$ adjacent to node $v$. Edges $e$ and $f$ have a clockwise (green) distance of 1 at $v$, meaning that there are no edges between them in an angular, clockwise ordering. Their counterclockwise distance (blue) ist 2. 
