...
These sink edges allow us to leave from and arrive at an original node $\ggv{x}{y}$.
...
For easy of notation, we also denote by $P(\gv)$ the grid coordinates of the original grid node $\gv^* = \ggv{x}{y}$ belonging to $\gv$.
