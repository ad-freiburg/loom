...
\newcommand\gvused[2]{x_{#1#2}}	% decision variable whether grid node #1 is assigned to input node #2
\newcommand\geused[2]{x_{#1#2}}	% decision variable whether grid edge #1 is used be input edge #2