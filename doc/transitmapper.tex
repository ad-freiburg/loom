...
See Section \ref{exampleinput} for an example input.

\begin{figure}[htbp]
  \centering
$	\vcenter{\hbox{\includegraphics[width=0.36\textwidth]{inputex.pdf}}}$
	\hspace{5mm}
	$	\vcenter{\hbox{\scalebox{2}{\large $\Rightarrow$}}} $
	\hspace{5mm}
$	\vcenter{\hbox{\includegraphics[width=0.36\textwidth]{test2.pdf}}}$
...
\begin{figure}
  \centering
	$	\vcenter{\hbox{\includegraphics[width=0.36\textwidth]{test2_thin.pdf}}}$
	\hspace{10mm}
$	\vcenter{\hbox{\includegraphics[width=0.36\textwidth]{test2_thick.pdf}}}$
...
\begin{figure}
  \centering
$	\vcenter{\hbox{\includegraphics[width=0.36\textwidth]{test2_nosmoothing.pdf}}}$
...
See also Section \ref{exampleinput}. The input format is a lightweight subset of GeoJSON. At the top level, the input JSON must contain a \texttt{FeatureCollection} object:
...
\begin{figure}
  \centering
$	\vcenter{\hbox{\includegraphics[width=0.36\textwidth]{test3.pdf}}}$
	\caption{The red line is not connected between the two main axes (via \texttt{exluded\_line\_conns})}
	\label{excllines}
\end{figure}
